...
const Home: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* مكونات المنتج */}
      <section className="container my-5" style={{ backgroundColor: 'var(--bg-color)', color: 'var(--text-color)' }}> {/* ← تعديل لتطبيق الثيم */}
      ...
      <section className="container my-5" style={{ backgroundColor: 'var(--bg-color)', color: 'var(--text-color)' }}> {/* ← تعديل لتطبيق الثيم */}
        ...
        <div className="row text-center">
          <div className="col-6 col-md-3 mb-4">
            <Link to="/soaps" className="text-decoration-none" style={{ color: 'var(--text-color)' }}>
              <img src="/assets/natural.jpg" alt="Soap" className="img-fluid rounded mb-2" />
              <h6>{t('categories.soap')}</h6>
            </Link>
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Link to="/serums" className="text-decoration-none" style={{ color: 'var(--text-color)' }}>
              <img src="/assets/serum.jpg" alt="Serum" className="img-fluid rounded mb-2" />
              <h6>{t('categories.serum')}</h6>
            </Link>
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Link to="/oils" className="text-decoration-none" style={{ color: 'var(--text-color)' }}>
              <img src="/assets/oils.jpg" alt="Oils" className="img-fluid rounded mb-2" />
              <h6>{t('categories.oil')}</h6>
            </Link>
          </div>
          <div className="col-6 col-md-3 mb-4">
            <Link to="/lip-care" className="text-decoration-none" style={{ color: 'var(--text-color)' }}>
